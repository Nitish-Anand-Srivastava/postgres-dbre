...
===============================================================================
SCRIPT NAME:
01_aurora_native_replica_lag.sql

PURPOSE:
Checks Aurora's native cluster-wide replica lag via the Aurora-specific function -- the correct source for reader lag on Aurora.
...
EXECUTION ORDER:
Step 01 of workflow 'replication-and-ha/replication-lag'
