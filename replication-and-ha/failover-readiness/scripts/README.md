# Scripts: Failover Readiness Assessment

Execution order, safety classification, and expected runtime for every script
in `replication-and-ha/failover-readiness/scripts/`.

| Order | Script | Purpose | Safety | Expected Runtime |
| ----- | ------ | ------- | ------ | ---------------- |
| 01 | `01_current_cluster_topology.sql` | Confirms current writer/reader role for the connection being tested, to be run against each endpoint your applications actually use. | READ ONLY | Low (sub-second to a few seconds) |
