...
EXECUTION ORDER:
Step 03 of workflow 'incident-response/post-deployment-incident'

RELATED SCRIPTS:
04_new_query_shapes.sql, ../../schema-changes/failed-index-build/README.md
