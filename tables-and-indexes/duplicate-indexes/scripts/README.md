# Scripts: Duplicate Indexes

Execution order, safety classification, and expected runtime for every script
in `tables-and-indexes/duplicate-indexes/scripts/`.

| Order | Script | Purpose | Safety | Expected Runtime |
| ----- | ------ | ------- | ------ | ---------------- |
| 01 | `01_duplicate_indexes.sql` | Finds indexes with identical normalized definitions on the same table. | READ ONLY | Low (sub-second to a few seconds) |
