...
===============================================================================
SCRIPT NAME:
02_statistics_freshness.sql

PURPOSE:
Checks whether stale statistics could be causing the planner to misjudge selectivity and avoid an existing index.
...
EXECUTION ORDER:
Step 02 of workflow 'tables-and-indexes/sequential-scan-investigation'
