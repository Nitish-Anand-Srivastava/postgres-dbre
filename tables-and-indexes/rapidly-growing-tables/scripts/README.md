# Scripts: Rapidly Growing Tables

Execution order, safety classification, and expected runtime for every script
in `tables-and-indexes/rapidly-growing-tables/scripts/`.

| Order | Script | Purpose | Safety | Expected Runtime |
| ----- | ------ | ------- | ------ | ---------------- |
| 01 | `01_growth_rate_from_history.sql` | Computes growth over a lookback window using a historical size-tracking table populated by automation/growth-monitoring. | READ ONLY | Low (sub-second to a few seconds) |
