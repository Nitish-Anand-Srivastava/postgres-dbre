...
===============================================================================
SCRIPT NAME:
01_growth_rate_from_history.sql

PURPOSE:
Computes growth over a lookback window using a historical size-tracking table populated by automation/growth-monitoring.
...
EXECUTION ORDER:
Step 01 of workflow 'tables-and-indexes/rapidly-growing-tables'

RELATED SCRIPTS:
../../automation/growth-monitoring/README.md
