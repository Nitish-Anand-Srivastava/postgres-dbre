# Scripts: Invalid Indexes

Execution order, safety classification, and expected runtime for every script
in `tables-and-indexes/invalid-indexes/scripts/`.

| Order | Script | Purpose | Safety | Expected Runtime |
| ----- | ------ | ------- | ------ | ---------------- |
| 01 | `01_invalid_indexes.sql` | Lists all indexes currently in an INVALID state. | READ ONLY | Low (sub-second to a few seconds) |
