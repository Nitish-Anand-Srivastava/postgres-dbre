# Scripts: Unused Indexes

Execution order, safety classification, and expected runtime for every script
in `tables-and-indexes/unused-indexes/scripts/`.

| Order | Script | Purpose | Safety | Expected Runtime |
| ----- | ------ | ------- | ------ | ---------------- |
| 01 | `01_unused_index_candidates.sql` | Lists candidate unused indexes, excluding those backing a constraint. | READ ONLY | Low (sub-second to a few seconds) |
