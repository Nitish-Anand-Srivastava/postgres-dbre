...
===============================================================================
SCRIPT NAME:
01_reindex_candidate_ranking.sql

PURPOSE:
Ranks indexes by size and usage to sequence the campaign, reusing the same bloat/usage view as the routine checklist.
...
EXECUTION ORDER:
Step 01 of workflow 'maintenance/reindex-strategy'
