...
PURPOSE:
Checks how stale planner statistics are across tables, since this checklist is often the first place staleness is noticed before it causes a plan regression.
...
EXECUTION ORDER:
Step 03 of workflow 'maintenance/routine-maintenance-checklist'
