...
===============================================================================
SCRIPT NAME:
01_key_settings_and_scope.sql

PURPOSE:
Snapshots the settings most commonly changed operationally, including each one's context, which indicates whether it can be changed dynamically, via SIGHUP, or only at instance start.
...
EXECUTION ORDER:
Step 01 of workflow 'maintenance/parameter-group-change-management'
