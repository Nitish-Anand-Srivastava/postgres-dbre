...
PURPOSE:
Checks for long-running transactions whose snapshot predates recent dead tuples, preventing vacuum from reclaiming them even if it can run.
...
EXECUTION ORDER:
Step 02 of workflow 'vacuum-and-autovacuum/vacuum-blocked'
