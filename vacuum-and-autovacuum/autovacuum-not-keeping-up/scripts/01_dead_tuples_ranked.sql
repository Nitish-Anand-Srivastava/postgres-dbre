...
===============================================================================
SCRIPT NAME:
01_dead_tuples_ranked.sql

PURPOSE:
Ranks tables by dead tuple count and ratio to find the worst autovacuum-lag offenders.
...
EXECUTION ORDER:
Step 01 of workflow 'vacuum-and-autovacuum/autovacuum-not-keeping-up'

RELATED SCRIPTS:
02_current_autovacuum_workers.sql
