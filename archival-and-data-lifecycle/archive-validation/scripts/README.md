# Scripts: Archive Validation

Execution order, safety classification, and expected runtime for every script
in `archival-and-data-lifecycle/archive-validation/scripts/`.

| Order | Script | Purpose | Safety | Expected Runtime |
| ----- | ------ | ------- | ------ | ---------------- |
| 01 | `01_periodic_archive_reconciliation.sql` | Re-runs the row-count/checksum reconciliation used during the original archive to confirm the archive remains intact over time. | READ ONLY | Low (sub-second to a few seconds) |
