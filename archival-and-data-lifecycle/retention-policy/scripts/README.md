# Scripts: Retention Policy Documentation and Enforcement

Execution order, safety classification, and expected runtime for every script
in `archival-and-data-lifecycle/retention-policy/scripts/`.

| Order | Script | Purpose | Safety | Expected Runtime |
| ----- | ------ | ------- | ------ | ---------------- |
| 01 | `01_growing_tables_without_retention_evidence.sql` | Surfaces large, continuously growing tables as candidates to audit against the retention-policy document. | READ ONLY | Low (sub-second to a few seconds) |
