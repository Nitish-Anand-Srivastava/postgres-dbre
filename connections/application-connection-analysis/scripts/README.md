# Scripts: Application-Level Connection Analysis

Execution order, safety classification, and expected runtime for every script
in `connections/application-connection-analysis/scripts/`.

| Order | Script | Purpose | Safety | Expected Runtime |
| ----- | ------ | ------- | ------ | ---------------- |
| 01 | `01_service_connection_detail.sql` | Detailed connection/state/query breakdown filtered to a specific application, for deep-dive analysis. | READ ONLY | Low (sub-second to a few seconds) |
