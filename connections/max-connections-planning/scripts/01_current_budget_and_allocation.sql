...
===============================================================================
SCRIPT NAME:
01_current_budget_and_allocation.sql

PURPOSE:
Establishes current max_connections budget and per-application actual usage as the planning baseline.
...
EXECUTION ORDER:
Step 01 of workflow 'connections/max-connections-planning'

RELATED SCRIPTS:
../connection-exhaustion/scripts/01_connection_headroom.sql
