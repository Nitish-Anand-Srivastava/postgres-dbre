# Scripts: max_connections Capacity Planning

Execution order, safety classification, and expected runtime for every script
in `connections/max-connections-planning/scripts/`.

| Order | Script | Purpose | Safety | Expected Runtime |
| ----- | ------ | ------- | ------ | ---------------- |
| 01 | `01_current_budget_and_allocation.sql` | Establishes current max_connections budget and per-application actual usage as the planning baseline. | READ ONLY | Low (sub-second to a few seconds) |
