...
===============================================================================
SCRIPT NAME:
03_idle_in_transaction_timeout_setting.sql

PURPOSE:
Confirms whether idle_in_transaction_session_timeout is configured, to assess whether this class of issue will self-resolve.
...
EXECUTION ORDER:
Step 03 of workflow 'concurrency-and-locking/idle-in-transaction'

RELATED SCRIPTS:
../../connections/idle-in-transaction/README.md
