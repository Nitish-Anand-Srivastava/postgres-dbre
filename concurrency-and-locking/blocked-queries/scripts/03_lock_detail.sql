...
PURPOSE:
Shows the raw lock detail (mode, object, granted state) behind the blocking relationship for precise diagnosis.
...
EXECUTION ORDER:
Step 03 of workflow 'concurrency-and-locking/blocked-queries'
