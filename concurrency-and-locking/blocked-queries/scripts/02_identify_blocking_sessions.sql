...
===============================================================================
SCRIPT NAME:
02_identify_blocking_sessions.sql

PURPOSE:
Expands each blocking relationship to show what the blocking session is doing and for how long.
...
EXECUTION ORDER:
Step 02 of workflow 'concurrency-and-locking/blocked-queries'

RELATED SCRIPTS:
01_identify_blocked_sessions.sql, 03_lock_detail.sql
