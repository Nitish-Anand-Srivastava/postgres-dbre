...
===============================================================================
SCRIPT NAME:
03_xid_age_impact.sql

PURPOSE:
Checks database-level transaction age to assess whether the long-running transaction is meaningfully delaying vacuum's ability to advance the freeze horizon.
...
EXECUTION ORDER:
Step 03 of workflow 'concurrency-and-locking/long-running-transactions'
