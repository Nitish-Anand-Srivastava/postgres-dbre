...
===============================================================================
SCRIPT NAME:
01_pruning_configuration_check.sql

PURPOSE:
Confirms partition pruning is enabled at the session/database level.
...
EXECUTION ORDER:
Step 01 of workflow 'partitioning/partition-pruning'

RELATED SCRIPTS:
02_explain_guidance.md
