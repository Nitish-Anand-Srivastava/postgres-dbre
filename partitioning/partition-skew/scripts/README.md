# Scripts: Partition Skew

Execution order, safety classification, and expected runtime for every script
in `partitioning/partition-skew/scripts/`.

| Order | Script | Purpose | Safety | Expected Runtime |
| ----- | ------ | ------- | ------ | ---------------- |
| 01 | `01_partition_size_distribution.sql` | Compares partition sizes across a partitioned table to identify skew. | READ ONLY | Low (sub-second to a few seconds) |
