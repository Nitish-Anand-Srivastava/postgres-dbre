# Scripts: Missing Partitions

Execution order, safety classification, and expected runtime for every script
in `partitioning/missing-partitions/scripts/`.

| Order | Script | Purpose | Safety | Expected Runtime |
| ----- | ------ | ------- | ------ | ---------------- |
| 01 | `01_default_partition_check.sql` | Checks whether a DEFAULT partition exists and how much data it currently holds. | READ ONLY | Low (sub-second to a few seconds) |
