# Scripts: Partition Performance

Execution order, safety classification, and expected runtime for every script
in `partitioning/partition-performance/scripts/`.

| Order | Script | Purpose | Safety | Expected Runtime |
| ----- | ------ | ------- | ------ | ---------------- |
| 01 | `01_partition_count_and_size_overview.sql` | Overview of total partition count and size distribution, to assess whether the granularity itself is appropriate. | READ ONLY | Low (sub-second to a few seconds) |
