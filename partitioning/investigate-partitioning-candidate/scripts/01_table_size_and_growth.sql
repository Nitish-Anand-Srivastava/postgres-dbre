...
===============================================================================
SCRIPT NAME:
01_table_size_and_growth.sql

PURPOSE:
Checks current size and row count for the candidate table as the baseline feasibility input.
...
EXECUTION ORDER:
Step 01 of workflow 'partitioning/investigate-partitioning-candidate'
