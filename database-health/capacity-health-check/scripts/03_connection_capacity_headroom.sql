...
===============================================================================
SCRIPT NAME:
03_connection_capacity_headroom.sql
...
EXECUTION ORDER:
Step 03 of workflow 'database-health/capacity-health-check'

RELATED SCRIPTS:
04_io_and_checkpoint_pressure.sql, ../../connections/max-connections-planning/README.md
