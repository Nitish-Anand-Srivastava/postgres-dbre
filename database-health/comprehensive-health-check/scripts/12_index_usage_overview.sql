...
EXECUTION ORDER:
Step 12 of workflow 'database-health/comprehensive-health-check'

RELATED SCRIPTS:
13_replication_and_reader_health.sql, ../../tables-and-indexes/unused-indexes/README.md
