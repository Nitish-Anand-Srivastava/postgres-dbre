...
===============================================================================
SCRIPT NAME:
10_top_queries_by_total_time.sql
...
EXECUTION ORDER:
Step 10 of workflow 'database-health/comprehensive-health-check'

RELATED SCRIPTS:
11_temp_file_usage.sql, ../../query-optimization/analyze-query-plan/README.md
