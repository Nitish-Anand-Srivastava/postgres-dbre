...
===============================================================================
SCRIPT NAME:
04_blocking_and_lock_check.sql
...
EXECUTION ORDER:
Step 04 of workflow 'database-health/post-maintenance-check'

RELATED SCRIPTS:
05_vacuum_and_xid_status.sql, ../../concurrency-and-locking/blocked-queries/README.md
