...
===============================================================================
SCRIPT NAME:
02_connection_headroom_and_mix.sql
...
EXECUTION ORDER:
Step 02 of workflow 'database-health/pre-maintenance-check'

RELATED SCRIPTS:
03_open_transactions_and_prepared.sql, ../../connections/connection-pooling/README.md
