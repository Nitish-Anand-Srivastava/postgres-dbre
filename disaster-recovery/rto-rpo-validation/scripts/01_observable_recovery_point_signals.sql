...
===============================================================================
SCRIPT NAME:
01_observable_recovery_point_signals.sql

PURPOSE:
Captures every recovery-point signal the database itself can report: instance role, Aurora reader lag, and replication slot lag with retained WAL.
...
EXECUTION ORDER:
Step 01 of workflow 'disaster-recovery/rto-rpo-validation'
