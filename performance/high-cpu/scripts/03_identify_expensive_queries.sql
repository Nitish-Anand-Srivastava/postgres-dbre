...
===============================================================================
SCRIPT NAME:
03_identify_expensive_queries.sql

PURPOSE:
Top statements by total execution time from pg_stat_statements, to find the historically dominant CPU consumers, not just this instant's snapshot.
...
EXECUTION ORDER:
Step 03 of workflow 'performance/high-cpu'

RELATED SCRIPTS:
02_identify_active_queries.sql, 04_check_wait_events.sql
