...
PURPOSE:
Identifies statements generating the most shared buffer reads, the strongest query-level proxy for storage I/O.
...
EXECUTION ORDER:
Step 02 of workflow 'performance/high-iops'

RELATED SCRIPTS:
03_io_by_backend_type.sql
