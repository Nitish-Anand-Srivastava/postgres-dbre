...
PURPOSE:
Identifies the single most impactful blocking session, if one exists, to prioritize the fastest possible fix.
...
EXECUTION ORDER:
Step 02 of workflow 'performance/sudden-performance-degradation'
