...
===============================================================================
SCRIPT NAME:
01_snapshot_current_state.sql

PURPOSE:
Captures a broad current-state snapshot (sessions, states, wait events) as the first forensic step.
...
EXECUTION ORDER:
Step 01 of workflow 'performance/sudden-performance-degradation'

RELATED SCRIPTS:
02_dominant_blocking_chain.sql
