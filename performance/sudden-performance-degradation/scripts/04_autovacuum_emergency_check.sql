...
PURPOSE:
Checks for an anti-wraparound or failsafe autovacuum currently running, which can consume significant resources and cannot be safely cancelled.
...
EXECUTION ORDER:
Step 04 of workflow 'performance/sudden-performance-degradation'
