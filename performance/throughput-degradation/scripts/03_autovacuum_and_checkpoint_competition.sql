...
PURPOSE:
Checks whether autovacuum or checkpoint activity is competing for the same resources as the throughput-sensitive workload.
...
EXECUTION ORDER:
Step 03 of workflow 'performance/throughput-degradation'

RELATED SCRIPTS:
04_connection_pool_headroom.sql
