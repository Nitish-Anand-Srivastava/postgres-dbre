...
PURPOSE:
Checks connection utilization, since pool exhaustion manifests to the application as latency (waiting for a connection) rather than a slow query.
...
EXECUTION ORDER:
Step 04 of workflow 'performance/high-latency'

RELATED SCRIPTS:
05_replication_lag_if_reader.sql
