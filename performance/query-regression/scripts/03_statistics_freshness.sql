...
PURPOSE:
Checks whether recent ANALYZE activity coincides with the regression's onset, and how much the table has changed since.
...
EXECUTION ORDER:
Step 03 of workflow 'performance/query-regression'

RELATED SCRIPTS:
04_table_size_growth.sql
