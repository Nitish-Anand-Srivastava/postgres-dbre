...
PURPOSE:
Surfaces the current top statements by total execution time, to identify any new queryid dominating since the deployment.
...
EXECUTION ORDER:
Step 02 of workflow 'performance/performance-after-deployment'
