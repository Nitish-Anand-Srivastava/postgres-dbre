...
===============================================================================
SCRIPT NAME:
01_invalid_indexes_since_deployment.sql

PURPOSE:
Checks for invalid indexes, the most common direct side effect of a deployment's failed CONCURRENTLY build.
...
EXECUTION ORDER:
Step 01 of workflow 'performance/performance-after-deployment'

RELATED SCRIPTS:
02_new_expensive_queries.sql
