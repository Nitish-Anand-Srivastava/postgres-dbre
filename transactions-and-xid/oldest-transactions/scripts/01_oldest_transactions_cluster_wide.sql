...
===============================================================================
SCRIPT NAME:
01_oldest_transactions_cluster_wide.sql

PURPOSE:
Lists the oldest currently open transactions across the instance, ranked by age.
...
EXECUTION ORDER:
Step 01 of workflow 'transactions-and-xid/oldest-transactions'
