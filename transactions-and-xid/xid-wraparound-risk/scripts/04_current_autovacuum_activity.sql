...
===============================================================================
SCRIPT NAME:
04_current_autovacuum_activity.sql

PURPOSE:
Confirms whether autovacuum is currently running, and on which tables, via pg_stat_progress_vacuum.
...
EXECUTION ORDER:
Step 04 of workflow 'transactions-and-xid/xid-wraparound-risk'
