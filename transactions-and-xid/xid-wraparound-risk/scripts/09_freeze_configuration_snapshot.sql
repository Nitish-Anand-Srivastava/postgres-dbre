...
===============================================================================
SCRIPT NAME:
09_freeze_configuration_snapshot.sql

PURPOSE:
Snapshots the current freeze-related configuration to interpret the ages found in scripts 01-03 against the actual thresholds in effect.
...
EXECUTION ORDER:
Step 09 of workflow 'transactions-and-xid/xid-wraparound-risk'
