...
===============================================================================
SCRIPT NAME:
01_multixact_age_ranked.sql

PURPOSE:
Ranks tables by multixact ID age, the primary signal for this workflow.
...
EXECUTION ORDER:
Step 01 of workflow 'transactions-and-xid/multixact-risk'
