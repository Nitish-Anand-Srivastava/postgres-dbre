...
===============================================================================
SCRIPT NAME:
01_list_prepared_transactions.sql

PURPOSE:
Lists all outstanding prepared (two-phase-commit) transactions and their age.
...
EXECUTION ORDER:
Step 01 of workflow 'transactions-and-xid/prepared-transactions'

RELATED SCRIPTS:
../xid-wraparound-risk/scripts/07_prepared_transactions.sql
