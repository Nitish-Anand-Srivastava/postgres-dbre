# Scripts: Prepared (Two-Phase-Commit) Transactions

Execution order, safety classification, and expected runtime for every script
in `transactions-and-xid/prepared-transactions/scripts/`.

| Order | Script | Purpose | Safety | Expected Runtime |
| ----- | ------ | ------- | ------ | ---------------- |
| 01 | `01_list_prepared_transactions.sql` | Lists all outstanding prepared (two-phase-commit) transactions and their age. | READ ONLY | Low (sub-second to a few seconds) |
