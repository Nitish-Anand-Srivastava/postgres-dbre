...
EXECUTION ORDER:
Step 02 of workflow 'query-optimization/nested-loop-problems'

RELATED SCRIPTS:
03_foreign_keys_missing_index.sql, ../../tables-and-indexes/sequential-scan-investigation/README.md
